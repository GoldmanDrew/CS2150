...
mergeSort:
	...
	cmp rdx, rsi		; cmp right and left
	jle ms_epilogue	; (if left >= right), goto ms_epilogue 
	...
	add [var], rsi
	mov rdx, [var]
	sar rdx, 1		; middle = (left + right)/2
	
	push rdx		; push middle
	call mergeSort		; 50% recursion
	...
	push rdx		; push right
	call mergeSort		; 100% recursion
	pop rdx		; right goes back
	pop rsi		; left goes back
	
	mov rcx, rdx		; mov paramter4
	add rdx, rsi		;
	sar rdx, 1		; (left+right)/2 = mid
